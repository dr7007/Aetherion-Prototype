...
public class SwordTrailB : MonoBehaviour
{
    ...
    public string[] targetAnimationStates = { "ComboB1", "ComboB2", "ComboB3" };
    ...
    void Update()
    {
        ...
        // ComboB3 상태
        else if (stateInfo.IsName("ComboB3"))
        {
            if (stateInfo.normalizedTime < trailEndOffset)
            {
